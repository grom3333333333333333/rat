document.addEventListener('DOMContentLoaded', function () {
    ...
    const ratingDataByMonth = {
        ...
        'July': [
            ...
            { name: 'Аня Миронова', avatar: 'img/аням.png', role: 'Редактор', tasks: { posts: 5, articles: 1, design: 0, events: 0, deadlines: 0, correction: 3, discussion: 0, penalty: 5 }, merch: { points: 2, networks: ['Худи (VK)', 'АП (VK)'] } },
            ...
            { name: 'Екатерина Фраерок', avatar: 'img/катя.png', role: 'Редактор', tasks: { posts: 1, articles: 1, design: 0, events: 0, deadlines: 1, correction: 0, discussion: 0, penalty: 5 }, merch: { points: 0, networks: ['Нет'] } },
            { name: 'Оля Шокорева', avatar: 'img/оля.png', role: 'Редактор', tasks: { posts: 7, articles: 1, design: 0, events: 0, deadlines: 1, correction: 0, discussion: 0, penalty: 5 }, merch: { points: 0, networks: ['Нет'] } },
