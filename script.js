document.addEventListener('DOMContentLoaded', function () {
    ...
    const ratingDataByMonth = {
        ...
        'July': [
			...
			{ name: 'Kulek Kulek', avatar: 'img/z.png', role: 'Администратор', tasks: { posts: 	3, articles: 0, design: 1, events: 0, deadlines: 0, correction: 0, discussion: 0  }, merch: { points: 0, networks: ['Везде.'] } },
