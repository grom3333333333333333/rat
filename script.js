document.addEventListener('DOMContentLoaded', function () {
    ...
    const ratingDataByMonth = {
        ...
        'July': [
			...
			{ name: 'Kulek Kulek', avatar: 'img/z.png', role: 'Администратор', tasks: { posts: 	5, articles: 0, design: 1, events: 0, deadlines: 0, correction: 2, discussion: 0  }, merch: { points: 0, networks: ['Везде.'] } },
            ...
            { name: 'Innokenty Formalin', avatar: 'img/кеша.png', role: 'Корректор', tasks: { posts: 0, articles: 0, design: 0, events: 0, deadlines: 0, correction: 5, discussion: 0  }, merch: { points: 3, networks: ['Худи (VK)', 'АП (VK)', 'Худи (ОК)'] } },
